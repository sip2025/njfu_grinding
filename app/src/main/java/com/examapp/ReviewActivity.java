...
public class ReviewActivity extends BaseActivity implements ReviewAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ExamHistoryEntry historyEntry = (ExamHistoryEntry) getIntent().getSerializableExtra(EXTRA_HISTORY_ENTRY);
    ...
    private void showSimilarQuestionsDialog(Question currentQuestion) {
        ...
        ExamHistoryEntry historyEntry = (ExamHistoryEntry) getIntent().getSerializableExtra(EXTRA_HISTORY_ENTRY);
        String subjectId = historyEntry != null ? historyEntry.getSubjectId() : null;
        ...
        new Thread(() -> {
            ...
            runOnUiThread(() -> {
                ...
                if (similarQuestions.isEmpty()) {
                    ...
                    rvSimilar.setLayoutManager(new LinearLayoutManager(ReviewActivity.this));
